...
* [Fairy Tale - Artificial General Intelligence Soltuions](https://github.com/fairy-tale-agi-solutions) - We use state of the art programming languages to help humanity create Safe AGI. We are also working on free or commercial open source software which has high value to humanity to get the funds to fund the Safe AGI research and implementation.
